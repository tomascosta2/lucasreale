...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      <div className="size-[690px] bg-[#2278FE]/70 blur-[230px] rounded-full absolute left-[calc(50%-345px)] -top-[320px]"></div>
      <div className="size-[690px] bg-[#2278FE]/70 rounded-full blur-[230px] absolute -right-[200px] top-[800px]"></div>
      ...
      <section className="py-[60px] md:py-[80px] px-4 relative">
        <div className="max-w-[900px] mx-auto bg-[#111] border border-white/50 rounded-[8px] p-8 md:p-12">
