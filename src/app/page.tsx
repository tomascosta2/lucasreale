...
export default function Home() {
  return (
    <div className="relative overflow-clip">
      <div className="size-[690px] bg-[#2278FE]/70 _blur-[230px] rounded-full absolute left-[calc(50%-345px)] -top-[320px]"></div>
      <div className="size-[690px] bg-[#2278FE]/70 rounded-full _blur-[230px] absolute -right-[200px] top-[1000px] md:top-[800px]"></div>
